 ...
 */
@Disabled
@Autonomous(name = "FTCOpenSourceAutonomousNoPause", group = "00-Autonomous", preselectTeleOp = "TyneyCompetitionCode")
public class FTCOpenSourceAutonomousNoPause extends LinearOpMode {
                        ...
                        switch (identifiedSpikeMarkLocation) {
                            case LEFT:
                                ...
                                traj8 = drive.trajectorySequenceBuilder(traj3.end())
                                        .lineToLinearHeading(getaprilpose(1,10,71,92, 71, 19))
                                        .build();
                                drive.followTrajectorySequence(traj8);
                                drop("frontr", "blue", pix);
                                mustaches.setPosition(.68);
                                traj7 = drive.trajectorySequenceBuilder(traj8.end())
                                        .splineToSplineHeading(new Pose2d(50, 67, Math.toRadians(-90)), Math.toRadians(-20))
                                        .splineToConstantHeading(new Vector2d(50, -26), Math.toRadians(90))
                                        .build();
                                drive.followTrajectorySequence(traj7);
                                break;
                            ...
                            case MIDDLE:
                                ...
                                skip(stop);
                                traj3 = drive.trajectorySequenceBuilder(traj7.end())
                                        .lineToLinearHeading(new Pose2d(14, 71.5, Math.toRadians(90)))
                                        .build();
                                drive.followTrajectorySequence(traj3);
                                traj8 = drive.trajectorySequenceBuilder(traj3.end())
                                        .lineToLinearHeading(getaprilpose(2,14.5F,70,90, 72, 21))
                                        .build();
                                drive.followTrajectorySequence(traj8);
                                drop("front", "blue", pix);
                            ...
                            case RIGHT:
                                ...
                                drive.followTrajectorySequence(traj3);
                                traj8 = drive.trajectorySequenceBuilder(traj3.end())
                                        .lineToLinearHeading(getaprilpose(3,21.5F,71,90, 72, 32))
                                        .build();
                                drive.followTrajectorySequence(traj8);
                                drop("frontl", "blue", pix);
                                traj13 = drive.trajectorySequenceBuilder(traj8.end())
                    ...
                    case RED_FAR:
                        ...
                        switch (identifiedSpikeMarkLocation) {
                            case RIGHT:
                                ...
                                drive.followTrajectorySequence(traj3);
                                traj8 = drive.trajectorySequenceBuilder(traj3.end())
                                        .lineToLinearHeading(getaprilpose(6, 28.5F,-71,-90, -72, 25))
                                        .build();
                                drive.followTrajectorySequence(traj8);
                                drop("frontl", "red", pix);
                                traj13 = drive.trajectorySequenceBuilder(traj8.end())
                            ...
                            case MIDDLE:
                                ...
                                drive.followTrajectorySequence(traj3);
                                traj8 = drive.trajectorySequenceBuilder(traj3.end())
                                        .lineToLinearHeading(getaprilpose(5,31.5F,-71,-90, -71, 21))
                                        .build();
                                drive.followTrajectorySequence(traj8);
                                drop("front", "red", pix);
                                traj13 = drive.trajectorySequenceBuilder(traj8.end())
    ...
    private void runTfodTensorFlow() {
        ...
        if (startPosition == FTCOpenSourceAutonomousNoPause.START_POSITION.RED_FAR || startPosition == FTCOpenSourceAutonomousNoPause.START_POSITION.BLUE_NEAR) {
            identifiedSpikeMarkLocation = FTCOpenSourceAutonomousNoPause.IDENTIFIED_SPIKE_MARK_LOCATION.LEFT;
        ...
        for (Recognition recognition : currentRecognitions) {
            ...
            if (recognition.getLabel() == "Blue Prop" || recognition.getLabel() == "Red Prop") {
                if (x < 350) {
                    identifiedSpikeMarkLocation = FTCOpenSourceAutonomousNoPause.IDENTIFIED_SPIKE_MARK_LOCATION.MIDDLE;
                } else {
                    identifiedSpikeMarkLocation = FTCOpenSourceAutonomousNoPause.IDENTIFIED_SPIKE_MARK_LOCATION.RIGHT;
                }
            } else {
                identifiedSpikeMarkLocation = FTCOpenSourceAutonomousNoPause.IDENTIFIED_SPIKE_MARK_LOCATION.LEFT;
            }
